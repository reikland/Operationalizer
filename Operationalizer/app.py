...
- UI (sidebar config, upload CSV, preview)
- Parsing topics
- Exécution pipeline + affichage + download CSV
...
from bootstrap import APP_DIR, CACHE_DIR, EXAMPLES_PATH, bootstrap_all
from csv_io import read_csv_flexible
from env_config import configure_env
from pipeline import run_pipeline
from topics_parsing import parse_topics_cell, unique_preserve_order

# IMPORTANT : bootstrap avant toute logique qui pourrait déclencher forecasting_tools
bootstrap_all()
